      ...
      <div class="h-full bg-black p-10 font-sans text-neutral-400 flex flex-col justify-between">
        <div class="content">
          ...
          <div class="education">
            ...
            <div class="projects">
            <!--[[ProjectsTemplate=<div class="flex flex-col">{{project.name}}: <p>{{DescriptionTemplate}}</p><p>{{LinksTemplate}}</p> </div>]]-->
            <!--[[ProjectDescriptionTemplate=<div class="flex gap-2 text-amber-400">{{project.description}} </div>]]-->
            <!--[[ProjectLinkTemplate=<div class="flex gap-2 text-blue-200">{{project.links}}</div>]]-->
